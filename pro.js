  ...
  fetch('/cgi-bin/get_photos.pl', {
    ...
    .then(data => {
      ...
      if (!data || data.length === 0) {
        container.innerHTML = '<p style="color: white;">No hidden photos available.</p>';
        return;
      }
      ...
      data.forEach(photo => {
        ...
        delBtn.className = 'inline-delete';
        delBtn.textContent = '🗑️ Delete';

        delBtn.onclick = () => {
          if (confirm("Delete this photo?")) {
            fetch('/cgi-bin/delete_photo.pl', {
              method: 'POST',
...
document.getElementById("deletePhoto").onclick = function () {
